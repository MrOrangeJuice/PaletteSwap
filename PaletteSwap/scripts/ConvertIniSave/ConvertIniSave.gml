...
function ConvertIniSave(){
	...
	global.colorblind = ini_read_real("options", "colorblindMode", false);
	global.music = ini_read_real("options", "musicToggle", true);
	global.fullscreen = ini_read_real("options", "fullscreen", true);
